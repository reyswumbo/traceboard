...
enum class ThemeMode { DEFAULT, COLOR_1 }
...
private val Color1Light = lightColorScheme(
...
private val Color1Dark = darkColorScheme(
...
fun TraceboardTheme(
    ...
    val colorScheme = when (themeMode) {
        ThemeMode.COLOR_1 -> {
            if (darkTheme) Color1Dark else Color1Light
        }
